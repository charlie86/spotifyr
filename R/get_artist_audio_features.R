...
get_artist_audio_features <- function(artist_name = NULL, artist_uri = NULL, use_artist_uri = FALSE, return_closest_artist = TRUE, album_types = 'album', message = FALSE, access_token = get_spotify_access_token()) {

    albums <- get_artist_albums(artist_name = artist_name, artist_uri = artist_uri, use_artist_uri = use_artist_uri, return_closest_artist = return_closest_artist, message = message, album_types = album_types, access_token = access_token)
