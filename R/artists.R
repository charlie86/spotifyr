...
get_artist <- function(id, market = NULL, Authorization = get_spotify_access_token()) {
...
get_artist_albums <- function(id, include_groups = c('album', 'single', 'appears_on', 'compilation'), market = NULL, limit = 20, offset = 0, Authorization = get_spotify_access_token()) {
...
get_artist_top_tracks <- function(id, market = 'US', Authorization = get_spotify_access_token()) {
